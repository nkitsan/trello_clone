...
+ Алгоритм создания календарных дел: открыть в меню вкладку календарь -> выбрать день в текущем месяце или выбрать месяц, а затем день т нажать на кнопку добавить мероприятие -> в открывшемся окне ввести название мероприятия, комментарий (дополнительную информацию, которую можно прочитать) и уведомления (из шаблонов или настроить самому с помощью выпадющего списка)
...
+ Алгоритм создания ежедневной задачи: открыть в меню вкладку трекер привычек -> под таблицей уже существующих привычек нажать на кнопку добавить новую привычку -> в открывшейся странице заполнить название привычки, продолжительность закрепления привычки и режим напоминаний (выбрать время напоминания из выпадающего списка). 
...
+ Алгоритм создания еженедельных задач: под списком Неделя нажать кнопку добавить карточку и ввести имя задачи в появившемся поле -> нажать на карточку и настроить повторяемость с помощью чеклиста дней недели, поставить напоминания с помощью шаблонов или настроить самому, добавить комментарий в поле комментарий, добавить чеклист подзадач по кнопке чеклист, а затем под надписью добавить элемент добавлять задачи чеклиста.
...
+ Алгоритм создания Чек-листа: создаем список по кнопке добавить список после последнего созданного списка -> под списком нажать кнопку добавить карточку и ввести имя элемента чеклиста в появившемся поле.
...
+ Алгоритм создания для планирования проекта: создаем список по кнопке добавить публичный список после последнего созданного списка -> под списком нажать кнопку добавить карточку и ввести имя задачи -> нажать на карточку и по кнопке исполнители добавить исполнителей по нику, добавить дедлайн с помощью выпадающего календаря по кнопке дедлайн, добавить комментарий в поле комментарий, добавить чеклист подзадач по кнопке чеклист, а затем под надписью добавить элемент добавлять задачи чеклиста.
