...
class PrivateTask:
    ...
    def post_task_params(self, task_id, repeat, remember, subtask, comment):
        """
    ...
    def put_task(self, task_id, name, status, deadline, subtask_id, subtask_status):
        """
    ...
    def delete_task_params(self, task_id, comment_id, subtask_id, repeat_id, remember_id):
        """
